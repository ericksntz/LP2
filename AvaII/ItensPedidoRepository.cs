...
class ItensPedidoRepository
{
    ...
    public bool MostrarItensPedidoProduto(int produtoid)
    {
        ...
        var command = connection.CreateCommand();
        command.CommandText = "SELECT count(itempedidocodproduto) FROM ItensPedido WHERE (itempedidocodproduto = $codproduto)";
        command.Parameters.AddWithValue("$codproduto", produtoid);
    ...
    public List<ItensPedido> GetByProdutoId(int codproduto)
    {
        var itenspedidos = new List<ItensPedido>();
        ...
        var command = connection.CreateCommand();
        command.CommandText = "SELECT * FROM ItensPedido WHERE (itempedidocodproduto = $codproduto)";
