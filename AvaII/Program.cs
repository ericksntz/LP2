...
else if (modelName == "Pedido")
{
    ...
    else if (modelAction == "MostrarPedidosCliente")
    {
        ...
        if (pedidoRepository.MostrarPedidosCliente(clienteid))
        {
            ...
            foreach (var pedido in pedidos)
            {
                ...
                {
                    if (vendedor.CodVendedor == pedido.PedidoCodVendedor)
                    {
                        Console.WriteLine($"{pedido.CodPedido,-15} {pedido.PrazoEntrega,-21} {pedido.DataPedido,-21} {pedido.PedidoCodVendedor,-17} {vendedor.Nome}");
                    }
                }
            }
        }
        ...
        {
            Console.WriteLine($"O cliente com código {clienteid} não existe.");
        }
    }
    ...
    else if (modelAction == "MostrarPedidosVendedor")
    {
        ...
        if (pedidoRepository.MostrarPedidosVendedor(vendedorid))
        {
            ...
            {
                Console.WriteLine($"{pedido.CodPedido,-15} {pedido.DataPedido}");
            }
        }
        else
        {
            Console.WriteLine($"O vendedor com código {vendedorid} não existe.");
        }
    }
    ...
    else if (modelAction == "MostrarQuantidadesProdutosPedido")
    {
        ...
        if (produtoRepository.Apresentar(produtoid))
        {
            ...
            if (itensPedidoRepository.MostrarItensPedidoProduto(produtoid))
            {
                ...
                {
                    Console.WriteLine($"{itenspedido.ItemPedidoCodPedido,-15} {produto.CodProduto,-16} {produto.Descricao,-15} {produto.ValorUnitario,-16} {itenspedido.Quantidade,-12} {(produto.ValorUnitario * itenspedido.Quantidade)}");
                }
            }
        }
        else
        {
            Console.WriteLine($"O produto com código {produtoid} não existe.");
        }
    }
}
